...
export default {
  ...
  cascades: {
    ...
    mode: {
      chain: 'цепочка',
      balancer: 'балансер',
      chainHint: 'Последовательно: вход → транзит → выход.',
      balancerHint: 'Один вход latency-балансирует по всем хопам ниже — каждый как равноправный параллельный выход (авто-узел «🚀 Оптимальная»).',
    },
  },
  squads: {
