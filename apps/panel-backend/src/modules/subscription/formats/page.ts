...
const L: Record<'ru' | 'en', Labels> = {
  en: {
    ...
    setup: 'Set up',
    pickPlatform: 'Pick your device, install an app below and tap “Open” — your subscription is added automatically. No app? Copy the link above and paste it into the app by hand.',
  ...
  ru: {
    ...
    subTarget: 'Подписка',
    setup: 'Установка',
    pickPlatform: 'Выберите устройство, установите приложение ниже и нажмите «Открыть» — подписка добавится сама. Нет приложения? Скопируйте ссылку выше и вставьте её в приложение вручную.',
